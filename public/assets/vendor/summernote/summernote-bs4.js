    ...
    value: function insertImage(src, param) {
      ...
      return createImage(src, param).then(function ($image) {
        ...
        if (typeof param === 'function') {
          ...
          $image.css('width', Math.min(_this3.$editable.width(), $image.width()) / 5);
        }
...
(external_jQuery_default()).summernote = external_jQuery_default().extend((external_jQuery_default()).summernote, {
  ...
  options: {
    ...
    toolbar: [['style', ['style']], ['fontsize', ['fontsize']], ['font', ['bold', 'italic', 'underline', 'clear']],['font', ['strikethrough', 'superscript', 'subscript']],['height', ['height']], ['fontname', ['fontname']], ['color', ['color']], ['para', ['ul', 'ol', 'paragraph']], ['table', ['table']], ['insert', ['link', 'picture', 'video']], ['view', ['codeview']]],
    // popover
    popatmouse: true,
    popover: {
    ...
    fontSizes: ['6','7','8', '9', '10', '11', '12', '14', '18', '20', '24', '26', '28', '30', '34', '36'],
    fontSizeUnits: ['px', 'pt'],
    ...
    lineHeights: ['0.5','0.6','0.7', '0.8', '0.9', '1.0', '1.2', '1.4', '1.5', '1.6', '1.8', '2.0', '3.0'],
...
var editor = renderer.create('<div class="note-editor note-frame card_"></div>');
